...
# Schedule Page
    ...
    st.write("To automate this process:")
    st.write("1. Deploy this Streamlit app to a server")
    st.write("2. Create an API endpoint that triggers the sending process")
    st.write("3. Set up a cron job at cron-job.org to call your API endpoint at the scheduled time")
    
    st.info("For demonstration purposes, you can use the button below to simulate scheduling")
